...
export default {  // приблизительный объект хранилища, может отличаться от реального
  ...
  getters: {
    ...
    putIntoDB() {  // затем полученные данные нужно положить в indexed db
    ...
    deleteFromDb() {  // удаляем данные источников данных из базы данных indexed db
      return  (ids,idDash) => { 
        let db = null;
        let nameDash = idDash;
        let searchName = [];
    ...
    getDashs: () => {   // получения списка дашбордов
      return (id) => {
