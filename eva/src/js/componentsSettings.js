  ...
  tools: [
    ...
    { name: 'Число', img: mdiNumeric, type: 'single' },
    {
      ...
      dataSourceDescription:
          ...
          + '-- residual=residual\n'
          + '| left | right | left_title | right_title | left_list_title | right_list_title | left_list_text_0 | right_list_text_0 | left_list_value_0 | right_list_value_0 | residual |\n'
          + '| -100 | 250 | "Заголовок 1" | Заголовок 2 | "Заголовок списка 1" | "Заголовок списка 2" | "Текст в списке 1" | "Текст в списке 2" | -100 | 250 | 150 |\n'
          + '| -100 | 250 | "Заголовок 1" | Заголовок 2 | "Заголовок списка 1" | "Заголовок списка 2" | "Текст в списке 1" | "Текст в списке 2" | :-- | :-- | :-- |\n'
          + '| -100 | 250 | "Заголовок 1" | Заголовок 2 | "Заголовок списка 1" | "Заголовок списка 2" | :-- | :-- | :-- | :-- | :-- |\n'
          + '| -100 | 250 | :-- | :-- | :-- | :-- | :-- | :-- | :-- | :-- | :-- |\n',
    },
    {
      name: 'Спидометр',
