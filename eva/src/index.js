...
import VueDraggableResizable from 'vue-draggable-resizable'; // сопоставляем подключенный компонент с комопнентом vue
...
// подключаем Vue
window.Vue = Vue; // позволяет создавтаь асинхронные computed
Vue.use(AsyncComputed); // подключаем библиотеку для перемещения и изменения размеров dashboard
Vue.component('vue-draggable-resizable', VueDraggableResizable); // подключаем стили для этого компонента
...
Vue.component(
  'dash-panel-bord',
  require('./components/dashPanelBoard.vue').default,
...
Vue.component(
  'modal-delete-main',
  require('./components/modalDeleteFromMain.vue').default,
...
Vue.component(
  'modal-schedule',
  require('./components/modalScheduler.vue').default,
...
Vue.component(
  'modal-settings',
  require('./components/modalSettings.vue').default,
); // модальное окно для импорта и экспорта
Vue.component(
  'theme-settings',
  require('./components/themeSettings.vue').default,
); // настройки системы
Vue.component(
  'dash-settings',
  require('./components/dashSettings.vue').default,
); // настройки дашборда
...
Vue.component(
  'dash-table',
  require('./components/dashBoardInside/dashTable.vue').default,
); // элемент таблицы
Vue.component(
  'dash-guntt',
  require('./components/dashBoardInside/dashGuntt.vue').default,
); // элемент диаграммы ганта
Vue.component(
  'dash-graph',
  require('./components/dashBoardInside/dashGraph.vue').default,
); // элемент графа
Vue.component(
  'dash-lineChart',
  require('./components/dashBoardInside/dashLineChart.vue').default,
); // элемент графика
Vue.component(
  'dash-multiLine',
  require('./components/dashBoardInside/MultiLine/MultiLine.vue').default,
); // элемент графика с несоклькими линиями
Vue.component(
  'dash-select',
  require('./components/dashBoardInside/dashSelect.vue').default,
); // элемент графика
Vue.component(
  'dash-picker',
  require('./components/dashBoardInside/dashDTPicker.vue').default,
); // элемент выбора даты и времени
Vue.component(
  'dash-single',
  require('./components/dashBoardInside/dashSingle.vue').default,
); // элемент вывода числа
Vue.component(
  'dash-button',
  require('./components/dashBoardInside/dashButton.vue').default,
); // элемент кнопки
Vue.component(
  'dash-textarea',
  require('./components/dashBoardInside/dashTextArea.vue').default,
); // элемент текстового поля
Vue.component(
  'dash-barchart',
  require('./components/dashBoardInside/dashBarChart.vue').default,
); // элемент столбцовой диаграммы
Vue.component(
  'dash-tile',
  require('./components/dashBoardInside/dashTile.vue').default,
); // элемент плиточной визуализации
Vue.component(
  'dash-csvg',
  require('./components/dashBoardInside/dashCSvg.vue').default,
); // элемент  визуализации svg
Vue.component(
  'dash-piechart',
  require('./components/dashBoardInside/dashPieChart.vue').default,
); // элемент  визуализации svg
Vue.component(
  'dash-ygraph',
  require('./components/dashBoardInside/dashYGraph.vue').default,
); // граф. новая версия
Vue.component(
  'dash-bush',
  require('./components/dashBoardInside/dashBush.vue').default,
); // компонент куст. на yfiles
Vue.component(
  'dash-map',
  require('./components/dashBoardInside/dashMap.vue').default,
); // компонент карта
Vue.component(
  'dash-heatmap',
  require('./components/dashBoardInside/dashHeatMap.vue').default,
); // компонент тепловая карта
Vue.component(
  'dash-tune',
  require('./components/dashBoardInside/dashTune.vue').default,
); // компонент ползунок
Vue.component(
  'dash-singleValue',
  require('./components/dashBoardInside/SingleValue/dashSingleValue.vue')
    .default,
