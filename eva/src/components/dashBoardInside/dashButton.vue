<template >
    <div class="dash-button" :options="options" style="padding: 0" @click="setClick">
        <div class="name" :style="{color:optionsData.colorText,height:`${height}px`,lineHeight:`${height-dataMode}px`,background:optionsData.background}">{{optionsData.name}}</div>
    </div>
</template>
