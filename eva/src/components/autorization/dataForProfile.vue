<template>
    <div class="field-profile more-data" :data-active="active" :style="{borderColor: colorFrom.border }">
        <div class="headline" :style="{color: colorFrom.text }" >{{alldata[essence][`${subessence}Name`]}}</div>
            <v-tabs   v-model="alldata[essence].tab[subessence]" :color='colorFrom.text' @change="switchTab" :style="{background: colorFrom.backElement }">
                ...
                <v-tab-item  class="item"  :value="'tab-1'">
                    ...
                    ></v-skeleton-loader>
                    <v-text-field v-model="searchText" v-if="!loaders[essence][subessence]" :append-icon="search"  label="Поиск" class="search-row" :color='colorFrom.controls' :style="{color: colorFrom.text }"  single-line hide-details ></v-text-field>
                ...
                <v-tab-item  class="item"  :value="'tab-2'">
                    <v-skeleton-loader
                        ...
                        class="skeleton-loader"
                    ></v-skeleton-loader>
                     <v-text-field v-model="searchText" v-if="!loaders[essence][`all${subessence}`]" :append-icon="search"  label="Поиск" class="search-row" :color='colorFrom.controls'  :style="{color: colorFrom.text }" single-line hide-details ></v-text-field>
